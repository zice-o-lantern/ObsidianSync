...
[[Lucas|LUCAS]]
Oh, I’m just teasing you==~~, hehe~~==[^5][^6][^13][^14][^15][^16].

<span style="color:rgb(126, 114, 218)">He giggles at his own tomfoolery.</span>
...
Anyway, it's nothing new that I get overtaken by these traces.

It was right here, in this house, 20 years ago, that it happened for the first time.
...
[^2]: S: actually in french when you greet someone in a phone call you say "Allo" who is a deformed version of Hello so in the original text they're already saying a kind of lingo

[^3]: M: that's what I thought might be happening, it felt like a translater thing hehe

[^4]:  S: I mean i was thinking of fnaf phone guy also

[^5]: M: Should we do more like... **He laughs** type thing or do you prefer typing it out? okay formatting text doesnt work in these things, thats meant to be italicized.

[^6]: S: Hmm the thing is as it's destined to be a visual novel, every action verbs used to describe how someone talks can break the flow like the *He laughs* will have to be put into a different dialogue bubble than "Oh I'm just teasing you" and i think it's easier to put it inside the dialogue directly than to create another bubble solely to describe an action. I sometimes break this rule for a meaningful action but when an onomatopoeia can be used instead, i don't bother

[^7]: M: The usage of the term dare here in english makes it sound like a threat LOL

[^8]: S: fair lol

[^9]: M: I changed the order of the question mark/uncertainty emphasis to better flow with english speaking patterns. more of a localization thing

[^10]: S: sure thanks!

[^11]: M: testing if this works, kind of a weird system

[^12]: S: yeah lol

[^13]: M: My biggest concern is that it sort of breaks the established flow within the text itself by swapping betwen onomatopoeia, partially because within english writing rules this is one of those things where we are taught young to "pick one" and be consistent with, as far as the flow of creative writing. We can just roll with it how it is, but as for a localization thing, it's something to consider/put a pin in for now and see how it feels in implementation. I was imagining the text bubble for these scene being "Oh, I'm just teasing you." _He laughs_ as one continuous thought and not two separate bubbles.

[^14]: Yeah but on the other hand, i think it breaks the flow to make a new bubble just to say he's laughing

[^15]: You misunderstand what I'm saying, it wouldn't be two bubbles but 1! 

[^16]: I don't see how that would work in a vn environment  

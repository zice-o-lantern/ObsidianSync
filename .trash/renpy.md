...
scene black
pause 2.0 
show text _("This story is not a work of fiction and is not based on real events. \nAny resemblance to actual persons, places, or events is purely coincidental.") with dissolve
pause 2.0
--->
...
Impossible de communiquer avec. Une fois le sceau brisé, le chat dans la boîte n’est plus {w}car c’est un nouveau chat. 
Alors, je me demande : {w}qu’adviendra de moi lorsqu’on défoncera la porte, {w}affaissé dans ma petite boite de ma propre création ?
